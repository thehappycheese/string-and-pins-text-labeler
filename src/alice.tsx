        ...
        <>
            <div class="chapter">
                ...
                <p>
                    ...
                    </i>, and looked at it, and then hurried on, Alice started
                    ...
                    she ran across the field after it, and fortunately was just
                    in time to see it pop down a large rabbit-hole under the
                    hedge.
                </p>
                ...
                <p>
                    ...
                    underneath, so managed to put it into one of the cupboards
                    as she fell past it.
                </p>
                ...
                <p>
                    Down, down, down. Would the fall <i>never</i>{" "}
                    come to an end? “I wonder how many miles I’ve fallen by this
                    ...
                    schoolroom, and though this was not a <i>very</i>{" "}
                    good opportunity for showing off her knowledge, as there was
                    no one to listen to her, still it was good practice to say
                    it over) “—yes, that’s about the right distance—but then I
                    wonder what Latitude or Longitude I’ve got to?” (Alice had
                    no idea what Latitude was, or Longitude either, but thought
                ...
                <p>
                    ...
                    that walk with their heads downward! The Antipathies, I
                    think—” (she was rather glad there <i>was</i>{" "}
                    no one listening, this time, as it didn’t sound at all the
                    right word) “—but I shall have to ask them what the name of
                    the country is, you know. Please, Ma’am, is this New Zealand
                    or Australia?” (and she tried to curtsey as she spoke—fancy
                    <i>curtseying</i>{" "}
                    as you’re falling through the air! Do you think you could
                    manage it?) “And what an ignorant little girl she’ll think
                    me for asking! No, it’ll never do to ask: perhaps I shall
                ...
                <p>
                    ...
                    be seen: she found herself in a long, low hall, which was
                ...
                <p>
                    ...
                    I think I could, if I only knew how to begin.” For, you see,
                ...
                <p>
                    ...
                    Alice was not going to do <i>that</i>{" "}
                    in a hurry. “No, I’ll look first,” she said, “and see
                    whether it’s marked ‘<i>poison</i>’ or not”; for she had
                    read several nice little histories about children who had
                    got burnt, and eaten up by wild beasts and other unpleasant
                    things, all because they <i>would</i>{" "}
                    not remember the simple rules their friends had taught them:
                    such as, that a red-hot poker will burn you if you hold it
                    too long; and that if you cut your finger <i>very</i>{" "}
                ...
                <p>
                    However, this bottle was <i>not</i>{" "}
                    marked “poison,” so Alice ventured to taste it, and finding
                    it very nice, (it had, in fact, a sort of mixed flavour of
                ...
                <p>
                    ...
                    to see if she was going to shrink any further: she felt a
                    ...
                    to fancy what the flame of a candle is like after the candle
                    is blown out, for she could not remember ever having seen
                    such a thing.
                </p>
                ...
                <p>
                    ...
                    see it quite plainly through the glass, and she tried her
                    best to climb up one of the legs of the table, but it was
                    too slippery; and when she had tired herself out with
                ...
                <p>
                    ...
                    currants. “Well, I’ll eat it,” said Alice, “and if it makes
                ...
                <p>
                    ...
                    feel which way it was growing, and she was quite surprised
                    to find that she remained the same size: to be sure, this
                    generally happens when one eats cake, but Alice had got so
                    much into the way of expecting nothing but out-of-the-way
...
export const alice_text = `<div class="chapter">
<h2>
CHAPTER I.<br />
    Down the Rabbit-Hole
</h2>
